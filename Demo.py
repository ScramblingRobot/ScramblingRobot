...
class CuBot:
    ...
    def R(self, numLayers, direction):
        ...
        if direction == 1:
            ...
            time.sleep(0.5)
            self.rightArm.rotate(-direction)
            self.rightArm.moveRelative(25, 0.02)
            time.sleep(0.1)
            self.centerArm.moveSmooth(self.centerArm.moveDictionary[31 + 5 - round(self.cube.width / 2) + (self.cube.layerWidth * numLayers)], 0.02) #move1
    ...
    def Y(self, direction):
        ...
        self.centerArm.grip(self.centerArm.gripCubeAngle)
        time.sleep(0.5)
        self.rightArm.grip(self.rightArm.gripDictionary[self.cube.width + 50])
        self.leftArm.grip(self.leftArm.gripDictionary[self.cube.width + 50])
        time.sleep(0.5)
        self.arms.moveSideArms(-50, 0)
        self.centerArm.rotate(0)
        self.centerArm.moveRelative(15 * -direction - 10, 0.01)
        time.sleep(0.5)
        self.arms.moveSideArms(50, 0)
        time.sleep(0.01)
        self.rightArm.grip(self.rightArm.gripCubeAngle)
    ...
    def D(self, numLayers, direction):
        ...
        if direction == -1:
            self.centerArm.grip(self.centerArm.gripDictionary[self.cube.width + 40])
            time.sleep(0.1)
            ...
            time.sleep(0.3)
            self.arms.moveSideArms(28, 0.005)
            time.sleep(0.3)
            self.centerArm.grip(self.centerArm.gripCubeAngle)
            time.sleep(0.5)
            self.centerArm.rotate(0)
            ...
            self.centerArm.grip(self.centerArm.gripClearanceAngle)
            time.sleep(0.5)
            self.arms.moveSideArms(22, 0.005)
            time.sleep(0.1)
